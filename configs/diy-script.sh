#!/bin/bash
# This scripts forked from: https://github.com/haiibo/OpenWrt/blob/main/diy-script.sh
...
git_sparse_clone main https://github.com/kenzok8/small-package redsocks2 lua-neturl
git_sparse_clone master https://github.com/vernesong/OpenClash luci-app-openclash
