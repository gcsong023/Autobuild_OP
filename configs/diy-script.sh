...
# nginx-manager
# svn export https://github.com/sundaqiang/openwrt-packages/trunk/luci-app-nginx-manager package/luci-app-nginx-manager

# 删除uhttpd
sed -i 's/+uhttpd +uhttpd-mod-ubus //g' feeds/luci/collections/luci/Makefile

#ssh 防护
# svn export https://github.com/kenzok8/small-package/trunk/luci-app-beardropper package/luci-app-beardropper
...
# svn export https://github.com/kenzok8/small-package/trunk/smartdns package/smartdns
...
sed -i '$a src-git kiddin https://github.com/kenzok8/small-package' feeds.conf.default
